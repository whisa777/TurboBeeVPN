...
При запросе подписки приложение автоматически отправляет идентификатор устройства (`x-hwid`) — это позволяет привязывать выданную подписку к вашему устройству.
